...
import { getAnimeResponse, getNestedAnimeResponse, produceNumber } from "../libs/api-libs";
...
export default async function Home() {
  ...
  let rekomendasiAnimes = await getNestedAnimeResponse("recommendations/anime","entry");
  ...
  return (
    <>
      ...
      <section className="p-4 flex flex-col gap-4">
        <div className="mt-[70px]">
          <Header title="Rekomendasi Anime Yang Mungkin Anda Suka" visibility={false} />
        </div>
        <div className="grid grid-cols-4 gap-4">
