                ...
                <div className="p-4 flex flex-col gap-4">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="w-[20%] h-auto group transition-all duration-500 ease-in-out relative overflow-hidden">
                            ...
                            />
                            <div className="w-full h-full transition-all duration-300 ease-in-out bg-primary bg-opacity-50 absolute top-96 group-hover:top-0">
                                <div className="w-full h-auto bg-acent p-2 absolute bottom-0 flex items-center justify-center">
                        ...
                        {/* main bar */}
                        <div className="w-[80%] bg-red-500 flex flex-col gap-2">    
                            <span className="w-full">{detailAnime.data.synopsis}</span>
